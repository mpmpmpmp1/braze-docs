...
Log into LILT and click into Connect. Click “New Connector” and select Braze.
	


Select the desired localization workflow for your Braze content.

	

Enter and verify the necessary configuration details:
Your Braze API Key
Braze REST endpoint

	

Click Verify to test the setup. Once the connection is confirmed, save the configuration.

### Step 2: Prepare your Braze workspace

Activate the multi-language capabilities within your Braze workspace settings.

	

Create the following tags in Braze for your LILT workflow: 
LILT: Ready
LILT: In progress
LILT: Sent to LILT
LILT: Delivered
...
Once the LILT <> Braze Connector is set up, use Liquid translation tags within your Braze email templates to identify content for translation. 
Example:  {% translation id_0 %}Hello, {{first_name}}!{% endtranslation %}
Initiate translation by updating the template tag to indicate the desired workflow: 
Choose “LILT: Ready” for Verified Translation
Choose “LILT: Instant” for brand-aligned Instant Translation
The LILT <> Braze Connector runs at your preset timing to pull the tagged content into LILT. Track translation progress, as content tags automatically update in Braze to reflect the stage of your project. 
